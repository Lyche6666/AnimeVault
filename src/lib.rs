...
#[derive(Debug)]
pub struct AnimeVaultProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AnimeVaultProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AnimeVault processing");
    
    let mut processor = AnimeVaultProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AnimeVaultProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AnimeVaultProcessor::new(false);
